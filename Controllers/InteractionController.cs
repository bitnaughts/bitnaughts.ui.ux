...
public class InteractionController : MonoBehaviour {
    ...
    public void Add (PointF point, float radius, string trigger, GameObject obj) {
        Add (new InteractionObject (point, radius, trigger, obj));
    }
    public void Add (float x, float y, float radius, string trigger, GameObject obj) {
        Add (new InteractionObject (new PointF (x, y), radius, trigger, obj));
    }
...
public class InteractionObject {
    ...
    public InteractionObject (PointF point, float radius, string trigger, GameObject obj) {
        this.point = point;
        this.radius = radius;
